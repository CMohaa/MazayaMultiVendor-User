...
public class CategoriesWPAdapter extends RecyclerView.Adapter<CategoriesWPAdapter.ViewHolder>   {
    private List<ProductCategory> productsList;
    public Context context;


    private OnCataClickListener onCataClickListener;
    public CategoriesWPAdapter(List<ProductCategory> _tradersList , OnCataClickListener onCataClickListener )
    {
