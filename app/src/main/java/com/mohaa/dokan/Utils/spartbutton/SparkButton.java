package com.mohaa.dokan.Utils.spartbutton;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    void init() {
       ...
       // circleView.setColors(Color.parseColor(("#04d39f"));
       ...
       // dotsView.setColors(Color.parseColor(("#04d39f")));
    ...
    private void getStuffFromXML(AttributeSet attr) {
        ...
        secondaryColor = ContextCompat.getColor(getContext(), a.getResourceId(R.styleable.sparkbutton_sparkbutton_secondaryColor, R.color.colorPrimaryTransparent));
